...
export const storyContent: SpeechContent = {
  segments: [
    ...
    "Jesus answered with a story. He said, A man was going down from Jerusalem to Jericho when he fell into the hands of robbers. They stripped him of his clothes, beat him, and went away, leaving him half dead on the side of the road.",

    "Now it happened that a priest was going down that same road. When he saw the man lying there, he passed by on the other side of the road and kept walking. He did not stop to help.",

    "Then a Levite, a helper at the temple, came to the same place. He too saw the injured man, but he also passed by on the other side of the road without stopping.",

    "But then a Samaritan, a man from a different country, came along the road. When he saw the injured man, his heart was filled with compassion. He went to him and bandaged his wounds, pouring oil and wine on them to help them heal. Then he put the man on his own donkey and brought him to an inn, where he took care of him.",

    "The next day, the Samaritan took out two silver coins and gave them to the innkeeper. He said, Take care of this man. If you spend more than this, I will pay you back when I return.",
